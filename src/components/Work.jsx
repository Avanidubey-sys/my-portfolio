...
const Work = () => {
  return (
    ...
    >
      ...
      >
        Here's a curated collection of my best work, highlighting my journey as
        a developer. Each project demonstrates my passion for clean design,
        functionality, and scalability. Take a look and discover how I turn
