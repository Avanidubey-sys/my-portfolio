...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "6bea8f4e-5c4c-43c2-8dac-cf10b02d8afb");
  ...
  return (
    ...
    scroll-mt-20 bg-violet-100 bg-no-repeat bg-center 
    bg-[length:90%_auto]'>
      <motion.h4 
...
Feel free to reach out via the contact form below or email me directly at dubeyavani18@gmail.com.
    ...
    transition={{duration: 0.6, delay:1.1}}
          ...
          initial={{opacity: 0, x:50}}
    whileInView={{opacity: 1, x:0}}
    transition={{duration: 0.6, delay:1.2}}type="email" placeholder='Enter your email' required
          className='flex-1 p-3 outline-none border-[0.5px] border-gray-400
    ...
    whileInView={{opacity: 1, y:0}}
    transition={{duration: 0.6, delay:1.1}}
         rows='6' placeholder='Enter your message' required className='w-full p-4 outline-none border-[0.5px] border-gray-400
